...
def main():
    ...
    plots(selection, bubble, insertion, shell)
...
def output(lists, sort_type):
    ...
    print(df)
    df.to_csv('{}_sort_results.csv'.format(sort_type), index=False)
    print("Dataframe Saved \n")


def plots(selection, bubble, insertion, shell):
    ...
    for i in range(0, 6, 2):
        ...
        rt_data = [selection_rt_data, bubble_rt_data, insertion_rt_data, shell_rt_data]
    ...
    for i in range(0, 6, 2):
        ...
        total_data = [selection_total_data, bubble_total_data, insertion_total_data, shell_total_data]
